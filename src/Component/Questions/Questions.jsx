...
const Questions = () => {
  ...
  return (
    <>
     <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-orange-300 via-orange-400 to-orange-500 py-20 px-4">
      <div className="w-full md:w-2/5 rounded-3xl bg-white bg-opacity-90 p-8 shadow-xl">
        ...
        <dl className="space-y-6 divide-y divide-orange-300/30">
          {faqs.map((faq, index) => (
            <div key={index}>
